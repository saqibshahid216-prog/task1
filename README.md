...
Source: Available via seaborn or other open sources.
...
Display shape, column names, and the first few rows using .shape, .columns, and .head().
...
Histogram: Examine the distribution of sepal length.

Box plot: Detect outliers and observe the spread of sepal length for each species.
...
Visual insights into feature relationships, distributions, and potential outliers.
